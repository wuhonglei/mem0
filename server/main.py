...
# 可选：自定义 LLM / Embedder（如 DashScope 通义千问等 OpenAI 兼容 API）
...
if MEM0_EMBEDDER_BASE_URL:
    _embedder_config["openai_base_url"] = MEM0_EMBEDDER_BASE_URL
if MEM0_EMBEDDER_DIMENSION:
    dim = int(MEM0_EMBEDDER_DIMENSION)
