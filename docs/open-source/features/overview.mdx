...
<CardGroup cols={3}>
  ...
  <Card title="Dream (self-hosted)" icon="moon" href="/open-source/features/dream">
    Merge duplicates, mark outdated facts, and synthesize patterns on the REST server.
  </Card>
  <Card title="Memory Decay (self-hosted)" icon="hourglass" href="/open-source/features/memory-decay">
    Category-aware search-time ranking bias with an observe-then-enforce rollout.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="OpenAI Compatibility" icon="message-bot" href="/open-source/features/openai-compatibility">
